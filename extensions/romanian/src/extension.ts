...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_romanian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_romanian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_romanian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_romanian.disableWorkspace', () => disable(false)),
    );
    //
}
