...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_ancient-greek.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_ancient-greek.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_ancient-greek.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_ancient-greek.disableWorkspace', () => disable(false)),
    );
    //
}
