...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_mongolian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_mongolian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_mongolian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_mongolian.disableWorkspace', () => disable(false)),
    );
    //
}
