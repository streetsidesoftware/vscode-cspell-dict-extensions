...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_finnish.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_finnish.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_finnish.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_finnish.disableWorkspace', () => disable(false)),
    );
    //
}
