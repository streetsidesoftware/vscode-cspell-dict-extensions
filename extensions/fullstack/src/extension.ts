...
import * as dict from 'cspell-dict-fullstack';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_fullstack.enableFullstack', () => enableFullstack(true)),
        vscode.commands.registerCommand('cSpellExt_fullstack.disableFullstack', () => disableFullstack(true)),
        vscode.commands.registerCommand('cSpellExt_fullstack.enableFullstackWorkspace', () => enableFullstack(false)),
        vscode.commands.registerCommand('cSpellExt_fullstack.disableFullstackWorkspace', () => disableFullstack(false)),
    );
