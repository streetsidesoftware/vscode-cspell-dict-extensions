...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_macedonian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_macedonian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_macedonian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_macedonian.disableWorkspace', () => disable(false)),
    );
    //
}
