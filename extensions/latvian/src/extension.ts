...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_latvian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_latvian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_latvian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_latvian.disableWorkspace', () => disable(false)),
    );
    //
}
