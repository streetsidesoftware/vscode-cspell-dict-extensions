...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_british-english-ise.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_british-english-ise.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_british-english-ise.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_british-english-ise.disableWorkspace', () => disable(false)),
    );
    //
}
