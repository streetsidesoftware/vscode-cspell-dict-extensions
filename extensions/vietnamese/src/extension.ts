...
import * as dict from 'cspell-dict-vi-vn';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    function enableVietnamese(isGlobal: boolean) {
        extension &&
            extension.activate().then((ext) => {
    ...
    function disableVietnamese(isGlobal: boolean) {
        extension &&
            extension.activate().then((ext) => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_vietnamese.enableVietnamese', () => enableVietnamese(true)),
        vscode.commands.registerCommand('cSpellExt_vietnamese.disableVietnamese', () => disableVietnamese(true)),
        vscode.commands.registerCommand('cSpellExt_vietnamese.enableVietnameseWorkspace', () =>
            enableVietnamese(false)
        ),
        vscode.commands.registerCommand('cSpellExt_vietnamese.disableVietnameseWorkspace', () =>
            disableVietnamese(false)
        )
    );
}
