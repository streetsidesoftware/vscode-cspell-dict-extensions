...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(
      'cSpellExt_vietnamese.enableVietnamese',
      () => enableVietnamese(true),
    ),
    vscode.commands.registerCommand(
      'cSpellExt_vietnamese.disableVietnamese',
      () => disableVietnamese(true),
    ),
    vscode.commands.registerCommand(
      'cSpellExt_vietnamese.enableVietnameseWorkspace',
      () => enableVietnamese(false),
    ),
    vscode.commands.registerCommand(
      'cSpellExt_vietnamese.disableVietnameseWorkspace',
