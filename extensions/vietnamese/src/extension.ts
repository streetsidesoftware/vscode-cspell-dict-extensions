...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_vietnamese.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_vietnamese.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_vietnamese.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_vietnamese.disableWorkspace', () => disable(false)),
    );
    //
}
