...
import * as dict from 'cspell-dict-pl_pl';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    function enablePolish(isGlobal: boolean) {
        extension &&
            extension.activate().then((ext) => {
    ...
    function disablePolish(isGlobal: boolean) {
        extension &&
            extension.activate().then((ext) => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_polish.enablePolish', () => enablePolish(true)),
        vscode.commands.registerCommand('cSpellExt_polish.disablePolish', () => disablePolish(true)),
        vscode.commands.registerCommand('cSpellExt_polish.enablePolishWorkspace', () => enablePolish(false)),
        vscode.commands.registerCommand('cSpellExt_polish.disablePolishWorkspace', () => disablePolish(false))
    );
}
