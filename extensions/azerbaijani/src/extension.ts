...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_azerbaijani.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_azerbaijani.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_azerbaijani.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_azerbaijani.disableWorkspace', () => disable(false)),
    );
    //
}
