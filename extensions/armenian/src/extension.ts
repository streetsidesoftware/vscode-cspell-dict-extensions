...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_armenian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_armenian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_armenian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_armenian.disableWorkspace', () => disable(false)),
    );
    //
}
