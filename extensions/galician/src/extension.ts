...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_galician.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_galician.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_galician.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_galician.disableWorkspace', () => disable(false)),
    );
    //
}
