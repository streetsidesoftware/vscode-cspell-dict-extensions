...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_hungarian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_hungarian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_hungarian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_hungarian.disableWorkspace', () => disable(false)),
    );
    //
}
