...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_indonesian.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_indonesian.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_indonesian.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_indonesian.disableWorkspace', () => disable(false)),
    );
    //
}
